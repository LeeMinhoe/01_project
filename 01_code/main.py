...
def run():
	...
	parser.add_option("-f", "--file", dest="target_file_name", help="target is json file name", metavar="TARGET file name")
	parser.add_option("-m", "--multi", dest="target_mdirectory_name", help="target is name of directory / N session", metavar="TARGET dir name")
	parser.add_option("-d", "--directory", dest="target_directory_name", help="target is name of directory that has \"header.json\"", metavar="TARGET dir name")
